...
<template>
  <v-card>
    ...
    <v-img src="/dotss.svg" height="800" cover>
      <div class="d-flex flex-column" style="height: 790px;">
        <iframe src='https://my.spline.design/splinedesigncourse-14afd61194b1e184e442b18af093be63/' frameborder='0' width='100%' height='100%'></iframe>
        <v-spacer />
